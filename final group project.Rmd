...
=======
  drop_na(country)
>>>>>>> fb9a8ef442bb16cf5e250e9fa061c17f76f83c89
...
<<<<<<< HEAD
ppp_data<- merge_data %>% mutate(ppp_salary = total_salary / Value) %>% 
filter(!is.na(Value))
=======
...
ppp_data %>%
  ...
  theme_bw()
>>>>>>> d3045def632985097e1e6f6144acfb9984b8b4f2
```
...
#      str_detect(ppp_data$industry, "Pharmaa*") ~ "Pharmaceuticals",
#      str_detect(ppp_data$industry, "^Edua*") ~ "Education",
